...
async def on_ready():
  ...
  async def on_message(message):
    ...
    if message.content.startswith('+help'):
      ...
      embed.add_field(name="hp", value="Starting & total HP per Blockmonster and average increment per level", inline=True)
      embed.add_field(name="evolution", value="Shows evolution level per Blockmonster and how much XP needed from the starting level to evolution level", inline=True)
    ...
    if message.content.startswith('+evolution'):
      embed=discord.Embed(title=f"XP", description="Will show the xp requirements to evolution", color=0xFF0000)
      embed.set_author(name="Encrypto", icon_url="https://s2.coinmarketcap.com/static/img/coins/64x64/11777.png")
      embed.add_field(name="Blockmonster", value= 
      "Flamisire\n\u200b"
      "Flamince\n\u200b"
      "Blazing\n\u200b" 
      "Orcalf\n\u200b" 
      ...
      "Saphiosys\n\u200b" 
      "Drakovein\n\u200b" , inline=True)
      embed.add_field(name="Level to Evolution", value= 
      "18\n\u200b"
      "36\n\u200b"
      "Max\n\u200b"
      "18\n\u200b"
      ...
      "Max\n\u200b"
      "Max\n\u200b", inline=True)
      embed.add_field(name="Total XP Needed", value= 
      "2295\n\u200b"
      "9450\n\u200b"
      "Null\n\u200b"
      "2295\n\u200b"
    ...
    if message.content.startswith('+hp'):
      embed=discord.Embed(title=f"HP Info.", description="Will show the HP from 1 to 100 and average HP amount per level", color=0xFF0000)
      embed.set_author(name="Encrypto", icon_url="https://s2.coinmarketcap.com/static/img/coins/64x64/11777.png")
      embed.add_field(name="Blockmonster", value= 
      "Flamisire\n\u200b"
      "Flamince\n\u200b"
      ...
      "Saphiosys\n\u200b" 
      "Drakovein\n\u200b" , inline=True)
      embed.add_field(name="Level 1 - 100", value= 
      "11 - 188\n\u200b"
      "12 - 226\n\u200b"
      "12 - 270\n\u200b"
      "11 - 198\n\u200b"
      ...
      "13 - 322\n\u200b"
      "Unknown\n\u200b", inline=True)
      embed.add_field(name="HP Increment Per Level", value= 
      "1.79\n\u200b"
      "2.17\n\u200b"
      "2.61\n\u200b"
      "1.89\n\u200b"
    ...
    if message.content.startswith('+saphiosys'):
      ...
      embed=discord.Embed(title=f"Saphiosys", description="Attacks, Status Ailments/Enhancements, XP & HP Information", color=0xD899E5)
      embed.set_author(name="Encrypto", icon_url="https://uploads-ssl.webflow.com/61b7ef3f6e1160ab79341eda/61b7f915817606d7c9e11639_image0%20(1)%202.png")
  ...
  # Report Spam in separate channel - replace channel to #ReportSpam
    ...
    # Reaction Based Emojis
      ...
      await message.add_reaction('<:commanderrankw:987354321823887400>')
    ...
    elif msg.lower().startswith('cool bot'):
